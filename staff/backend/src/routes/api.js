...
import { getDevices, getDeviceById, createDevice, updateDeviceStatus, deleteDevice, cleanRejectedStock, cleanDatabase } from '../controllers/deviceController.js';
...
router.post('/devices/clean-rejected', authenticateToken, cleanRejectedStock);
